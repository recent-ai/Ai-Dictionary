  ...
  "introduction-to-deep-learning": [
    {
      ...
      type: "title",
      data: {
        content: "Introduction to Deep Learning: Foundations & Modern Techniques",
        level: 1,
    ...
    },
    {
      ...
      type: "summary",
      data: {
        content: "This guide explains the fundamentals of deep learning, neural network structures, and training techniques. Perfect for beginners looking to understand the core ideas behind modern AI."
      }
    },
    {
      id: "3",
...
print(model.forward(np.array([1, 0.5, -1])))`
    ...
    },
    {
      ...
      type: "related_topics",
      data: {
        topics: ["Neural Networks", "Activation Functions", "Gradient Descent", "Backpropagation"]
      }
    }
  ],
  ...
  "cloud-architecture-basics": [
    {
      ...
      type: "title",
      data: {
        content: "Cloud Architecture Basics: Understanding Compute, Storage & Networking",
        level: 1,
    ...
    },
    {
      ...
      type: "summary",
      data: {
        content: "Learn the foundational components of cloud computing including compute services, storage solutions, and networking models across platforms like AWS, Azure, and GCP."
      }
    },
    {
      id: "3",
  ...
  "react-performance-optimizations": [
    {
      ...
      type: "title",
      data: {
        content: "React Performance Optimizations: Boosting Speed & Reducing Renders",
        level: 1,
    ...
    },
    {
      ...
      type: "summary",
      data: {
        content: "A deep dive into improving React performance using memoization, virtualization, code-splitting, and intelligent state management."
      }
    },
    {
      id: "3",
...
export default Card;`
    ...
    },
    {
      ...
      type: "related_topics",
      data: {
        topics: ["Virtual DOM", "React Hooks", "Code Splitting", "State Management"]
      }
    }
  ],
  ...
  "sql-database-design-fundamentals": [
    {
      ...
      type: "title",
      data: {
        content: "SQL Database Design Fundamentals: Schemas, Indexing & Normalization",
        level: 1,
    ...
    },
    {
      ...
      type: "summary",
      data: {
        content: "A beginner-friendly explanation of how to design relational databases, including table structures, normalization, indexing, and query optimization."
      }
    },
    {
      id: "3",
  ...
  created_at TIMESTAMP DEFAULT NOW()
    ...
    },
    {
      ...
      type: "related_topics",
      data: {
        topics: ["Normalization", "SQL Joins", "Query Optimization", "Transactions"]
      }
    }
  ],
  ...
  "foundations-of-cybersecurity": [
    {
      ...
      type: "title",
      data: {
        content: "Foundations of Cybersecurity: Threats, Attacks & Defense Strategies",
        level: 1,
    ...
    },
    {
      ...
      type: "summary",
      data: {
        content: "A complete overview of modern cybersecurity: common attack types, prevention techniques, and security best practices for individuals and organizations."
      }
    },
    {
      id: "3",
...
nmap -sV 192.168.1.0/24`
    ...
    },
    {
      ...
      type: "related_topics",
      data: {
        topics: ["Encryption", "Firewalls", "Penetration Testing", "Zero Trust Architecture"]
      }
    }
  ]
};
