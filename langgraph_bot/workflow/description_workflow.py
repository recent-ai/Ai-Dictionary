...
desc.add_edge("load_data","description_agent")
desc.add_edge("description_agent","arxiv_node")
desc.add_edge("description_agent","parser_tool")
desc.add_edge("description_agent","tavily_tool")
...
inputs = {
    "messages": [
        HumanMessage(
            content="create a description for the LLM temporal collaps problem"
        )
    ]
}
...
g.get_graph().draw_mermaid_png(output_file_path='./description.png')